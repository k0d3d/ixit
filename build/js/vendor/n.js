...
(function (b) {
  b.bigBox = function (a, h) {
    ...
    if (isIE8orlower() == 0) {
      var i = document.createElement("audio");
      i.setAttribute("src", "/sound/bigbox.mp3");
      b.get();
      i.addEventListener("load", function () {
        i.play()
      }, true);
    ...
    BigBoxes = BigBoxes + 1;
    k = "<div id='bigBox" + BigBoxes + "' class='bigBox animated fadeIn fast'><div id='bigBoxColor" + BigBoxes + "'><i class='botClose fa fa-times' id='botClose" + BigBoxes + "'></i>";
    k += "<span>" + a.title + "</span>";
    k += "<p>" + a.content + "</p>";
...
(function (b) {
  b.smallBox = function (o, j) {
    ...
    if (o.icon == undefined) {
      ...
      p = "<div class='miniIcono'><i class='miniPic' src='" + o.icon + "'></i></div>"
    }
    if (o.img == undefined) {
